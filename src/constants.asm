...
CHRTBL2_SECONDARY:	equ	#4000	; these are for the second buffer in MSX2 computers
CLRTBL2_SECONDARY:	equ	#6000
...
INTERRUPTS_PER_GAME_FRAME_50Hz:	equ 4
INTERRUPTS_PER_GAME_FRAME_60Hz:	equ 5
...
MAP_TILE_DOOR:			equ	1 
MAP_TILE_EXIT:			equ	4
MAP_TILE_EXIT2:			equ	5
MAP_TILE_MIRROR_WALL:	equ	6
...
MUSIC_CMD_END:                	equ #0a+MUSIC_CMD_FLAG
SFX_CMD_END:                	equ #0b+MUSIC_CMD_FLAG
